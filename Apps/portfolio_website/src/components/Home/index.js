    ...
    render() {
        return(
             <div className="head">
                ...
                <img className="bio" src="images/Shanice2020.jpg" alt="Shanice" />
                ...
                Let's make magic together... or websites, whatever floats your boat. Oh! By the way this website is running in react.
                </p>  
                </div>
